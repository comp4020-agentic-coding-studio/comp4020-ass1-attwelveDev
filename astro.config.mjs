...
// internal link is instead written relative to the current page (see
// Layout.astro) so it resolves the same way locally and once deployed.
export default defineConfig({
  base: "/comp4020-ass1-attwelveDev",
